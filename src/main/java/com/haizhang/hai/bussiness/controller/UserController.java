...
import com.haizhang.hai.bussiness.dto.RspDTO;
...
import com.haizhang.hai.futrue.MyFutureTask;
...
import com.haizhang.hai.constant.Constant;
import com.haizhang.hai.exception.BizException;
...
public class UserController extends AbstractController {
    ...
    public RspDTO getUser(Long userId) {
        ...
        return new RspDTO<User>().success(user.get());
    }
    ...
    public RspDTO update(@RequestBody @Validated(Update.class) UserDTO userDTO) {
        User i = userService.updateById(userDTO);
